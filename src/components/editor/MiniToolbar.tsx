...
import { ChevronLeftIcon, ChevronRightLightIcon, HandIcon } from "~/components/ui/Icon";
...
export const MiniToolbar: React.FC = () => {
  ...
  return (
    <div className="flex border-t border-r rounded-tr p-1 items-center divide-x bg-gray-100">
      <IconButton
